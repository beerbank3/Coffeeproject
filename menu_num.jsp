	...
	<body class="is-preload homepage">
		<div id="page-wrapper">
			...
			<div id="main-wrapper">
					<div class="container">
			<%if(rs.next()){%>
				<h2>주문번호는 <b style ="color:green";><%=rs.getString("num") %></b> 번 입니다.</h2>
				<h5>메뉴는 <%=rs.getString("menu") %> 입니다.</h5>
				<h5>주문하신 갯수는 <%=rs.getString("count")%> 개 입니다.</h5>
				<h5>총 가격은  <%=rs.getString("price")%> 입니다.</h5>
			<%}
			try{
 			pstmt.close();
 			conn.close();
